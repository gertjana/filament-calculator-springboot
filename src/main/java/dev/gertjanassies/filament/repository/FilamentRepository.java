...
public interface FilamentRepository {
    ...
    /**
     * Find a filament by its code.
     * @param code  The code of the filament to find.
     * @return  A Result containing the found filament or an error message.
     */

    Result<Filament, String> findByCode(String code);
    /**
    ...
    /**
     * Delete a filament by its code.
     * @param code The code of the filament to delete.
     * @return A Result indicating success or failure of the delete operation.
     */
    Result<Void, String> deleteByCode(String code);
}
